const en = {
  ...
  "common.responseBody": "Response body",
  "common.admin": "Admin",
  "common.owner": "Owner",
  ...
  "licenses.total": "{total} licenses in total",
  ...
  "apiKeys.namePlaceholder": "e.g. CI releases, production backend",
  ...
  "settings.languageDesc": "Switches this interface now and becomes the default for first-time visitors.",
  ...
  "login.welcomeDesc": "Sign in securely to access your account, licenses, and the management tools available to you.",
