const zh = {
  ...
  "apiKeys.namePlaceholder": "例如：CI 发布、生产环境后端",
  ...
  "customers.noLicenses": "暂无许可证。",
  "customers.noSubscriptions": "暂无订阅。",
  ...
  "settings.languageDesc": "立即切换当前界面，并作为新浏览器首次访问时的默认语言。",
  ...
  "login.welcomeDesc": "安全登录您的工作空间，访问账户、许可证以及您有权限使用的管理功能。",
  ...
  "portal.noQuotaFeatures": "暂无配额型功能。",
